                    ...
                    <div className="flex flex-col md:flex-row gap-4 mb-2">
                        ...
                        { similarRecipesLoading ? <h1>Loading...</h1> :
                            <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 md:auto-rows-max gap-4">
                                    {
                                        similarRecipes.map(plate =>
                                            <Link to={`../${plate.id}`} key={plate.id} className="relative">
                                            <div className="max-w-[24rem] overflow-hidden">
                                              <img
                                                className="block h-40 w-96 object-cover rounded-sm"
